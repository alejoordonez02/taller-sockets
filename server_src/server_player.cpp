...
Player::Player(const std::string& username):
        ...
        money(500),
        knife(true),
        primary(Weapon::create(WeaponName::NONE)),
        secondary(Weapon::create(WeaponName::GLOCK)) {}
...
bool Player::get_knife() const { return knife; }

WeaponName Player::get_primary_name() const { return primary->get_name(); }

int Player::get_ammo_primary() const { return primary->get_ammo(); }

WeaponName Player::get_secondary_name() const { return secondary->get_name(); }

int Player::get_ammo_secondary() const { return secondary->get_ammo(); }
